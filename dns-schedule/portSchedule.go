...
func init() {
    flag.StringVar(&configfile, "config-file", "/etc/hades/hades-schedule.conf", "read config from the file")
    flag.Parse()
...
func main() {
    glog.V(0).Infoln("Starting hades-schedule-agent...")
